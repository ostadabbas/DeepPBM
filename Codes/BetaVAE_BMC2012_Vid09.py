...
class VAE(nn.Module):
    def __init__(self):
        ...
        self.efc1  = nn.Linear(h_layer_4 * feature_row * feature_col, h_layer_5)
        ...
        self.dfc2 = nn.Linear(h_layer_5, h_layer_4 * feature_row * feature_col)
    ...
    def Encoder(self, x):
        ...
        eh5 = self.relu(self.edrop1(self.efc1(eh4.view(-1, h_layer_4 * feature_row * feature_col))))
        mu_z = self.mu_z(eh5)
    ...
    def Decoder(self, z):
        ...
        dh3 = self.relu(self.dbn1(self.dconv1(dh2.view(-1, h_layer_4, feature_row, feature_col))))
